...
final _url = "/health_metrics";

class RemoteMetricsService extends ConfigServices {
  RemoteMetricsService({required Dio dio}) : super(dio: dio);
  ...
  Future<List<Metrics>> getMetrics() async {
    try {
      ...
      throw Exception("Unexpected error loading health metrics: $e");
    }
  }
}
